from fitness_app.routes.running import calculate_calories as running_calories, get_running_met

from fitness_app.routes.walking import calculate_calories as walking_calories, get_walking_met

from fitness_app.routes.cycling import calculate_calories as cycling_calories, get_cycling_met

from fitness_app.routes.swimming import calculate_calories as swimming_calories, get_swimming_met
